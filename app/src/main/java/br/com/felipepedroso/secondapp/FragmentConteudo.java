 ...
 */
public class FragmentConteudo extends Fragment implements IInflated {

    private boolean mSearchCheck;
    private static final String TEXT_FRAGMENT = "TEXT_FRAGMENT";

    public FragmentConteudo newInstance(String text){
        FragmentConteudo mFragment = new FragmentConteudo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_conteudo, container, false);

        TextView mTxtTitle = (TextView) rootView.findViewById(R.id.mensagem_conteudo);
